...
(1, 2, 150.00, 'USD', 'Invoice INV-1001', 'SUCCESS', NULL, NULL, 'idem-0001'),
(2, 3, 220.50, 'USD', 'Subscription fee', 'SUCCESS', NULL, NULL, 'idem-0002'),
(3, 4, 75.25, 'EUR', 'Travel reimbursement', 'FAILED', 'INSUFFICIENT_FUNDS', 'Insufficient account balance', 'idem-0003'),
(4, 5, 40.00, 'GBP', 'Gift transfer', 'SUCCESS', NULL, NULL, 'idem-0004'),
(5, 6, 500.00, 'USD', 'Rent payment', 'FAILED', 'ACCOUNT_BLOCKED', 'Source account is suspended', 'idem-0005'),
(6, 7, 130.10, 'EUR', 'Utility bill', 'SUCCESS', NULL, NULL, 'idem-0006'),
(7, 8, 915.00, 'USD', 'Laptop purchase', 'SUCCESS', NULL, NULL, 'idem-0007'),
(8, 9, 1200.00, 'JPY', 'Supplier payout', 'SUCCESS', NULL, NULL, 'idem-0008'),
(9, 10, 310.75, 'EUR', 'Insurance premium', 'FAILED', 'LIMIT_EXCEEDED', 'Daily transaction limit exceeded', 'idem-0009'),
(10, 11, 60.00, 'USD', 'Dining split', 'SUCCESS', NULL, NULL, 'idem-0010'),
(11, 12, 4500.00, 'INR', 'Quarterly tax', 'SUCCESS', NULL, NULL, 'idem-0011'),
(12, 13, 95.30, 'GBP', 'Mobile recharge', 'FAILED', 'ACCOUNT_INACTIVE', 'Source account is inactive', 'idem-0012'),
(13, 14, 780.00, 'KRW', 'Vendor settlement', 'SUCCESS', NULL, NULL, 'idem-0013'),
(14, 15, 145.99, 'USD', 'Event ticket', 'SUCCESS', NULL, NULL, 'idem-0014'),
...
(1, 'CREATED', 'SUCCESS', 'system', 'Payment completed'),
(2, 'CREATED', 'SUCCESS', 'system', 'Payment completed'),
(3, 'CREATED', 'FAILED', 'system', 'Failure due to insufficient funds'),
(4, 'CREATED', 'SUCCESS', 'system', 'Payment completed'),
(5, 'CREATED', 'FAILED', 'system', 'Source account is suspended'),
(6, 'CREATED', 'SUCCESS', 'system', 'Payment completed'),
(7, 'CREATED', 'SUCCESS', 'system', 'Payment completed'),
(8, 'CREATED', 'SUCCESS', 'system', 'Payment completed'),
(9, 'CREATED', 'FAILED', 'system', 'Transaction limit exceeded'),
(10, 'CREATED', 'SUCCESS', 'system', 'Payment completed'),
(11, 'CREATED', 'SUCCESS', 'system', 'Payment completed'),
(12, 'CREATED', 'FAILED', 'system', 'Source account is inactive'),
(13, 'CREATED', 'SUCCESS', 'system', 'Payment completed'),
(14, 'CREATED', 'SUCCESS', 'system', 'Payment completed'),
